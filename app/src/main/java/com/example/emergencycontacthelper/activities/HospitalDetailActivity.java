...
public class HospitalDetailActivity extends AppCompatActivity {
    ...
    private String hospitalPhone = "123-456-789"; // Default
    ...
    private void loadSavedNumber() {
        hospitalPhone = dbHelper.getServicePhone(loggedUserId, "Hospital", "123-456-789");
        tvPhoneNumber.setText(hospitalPhone);
    }
